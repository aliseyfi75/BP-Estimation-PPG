...
if __name__ == "__main__":
    ...
    parser.add_argument("-d", "--video_directory", help="Directory with subfolders for identity", default="../PPG/videos/")
    parser.add_argument("-o", "--output_folder", help="Directory where to store computed csvs", default="../PPG/extracted/")
