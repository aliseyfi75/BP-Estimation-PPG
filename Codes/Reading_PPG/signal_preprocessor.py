...
if __name__ == "__main__":
    ...
    parser.add_argument("-d", "--signals_directory", help="Directory with subfolders for identity", default="../PPG/extracted/")
    parser.add_argument("-o", "--output_folder", help="Directory where to store filtered csvs", default="../PPG/processed/")
